          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="p-4 bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg border border-primary/20 hover:border-primary/40 transition-all duration-300"
              >
                <BookOpen className="h-6 w-6 text-primary mb-2" />
                <h3 className="font-medium">Write in Journal</h3>
              ...
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="p-4 bg-gradient-to-r from-pink-500/10 to-pink-500/5 rounded-lg border border-pink-500/20 hover:border-pink-500/40 transition-all duration-300"
              >
              ...
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="p-4 bg-gradient-to-r from-green-500/10 to-green-500/5 rounded-lg border border-green-500/20 hover:border-green-500/40 transition-all duration-300"
              >
                <Target className="h-6 w-6 text-green-500 mb-2" />
                <h3 className="font-medium">Check Habits</h3>
                <p className="text-sm text-muted-foreground">Mark today's progress</p>
              </motion.button>
            </div>
          </CardContent>
        </Card>
